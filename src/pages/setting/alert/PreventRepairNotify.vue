...
const user_level = proxy.gstate.level.AlertPreventRepairNotify; //권한레벨
  ...
  <div v-if="user_level >= 2">
    ...
    <div class="mt-5 grid grid-cols-12 gap-1">
      <div class="col-span-2 border-r-2 border-slate-200" style="height: 640px">
        <div><AlertSelect 설비수리통보_variant="primary" /></div>
      </div>
          ...
          >
            <div class="flex items-center">
              <div class="flex m-auto mt-5">
                <img
                  src="../../../assets/images/kakao_template/PreventRepairNotify.png"
                />
              </div>
            </div>
