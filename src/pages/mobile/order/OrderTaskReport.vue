      ...
      <div class="item" style="flex: 1 1 40%">
        ...
        <div class="grid grid-cols-12 gap-1 mt-1">
          ...
          >
            ...
            <div class="ml-auto mr-3 relative w-32 text-slate-500">
              <FormInput
                type="text"
          ...
          <div class="flex col-span-12 items-center intro-y">
            <div class="flex mr-auto ml-3">
              <span class="mr-3"
              ...
              <table class="border-2 border-gray-500 w-full">
                <tbody class="text-center">
                  <tr class="h-7 font-bold bg-slate-200">
                    <td class="w-[35%] border-2 border-gray-500">순번</td>
                    <td class="w-[65%] border-2 border-gray-500">작업코드</td>
                  </tr>
                  <tr class="h-7">
                  ...
                  <tr class="h-7 font-bold bg-slate-200">
                    <td class="border-2 border-gray-500">품명</td>
                    <td class="border-2 border-gray-500">공정명</td>
                  </tr>
                  <tr class="h-7">
                    <td class="border-2 border-gray-500">
                      {{ todo[table_setting.항목7.name] }}
                    </td>
                    <td class="border-2 border-gray-500">
                  ...
                  <tr class="h-7 font-bold bg-slate-200">
                    ...
                    <td class="border-2 border-gray-500">지시수량</td>
                  </tr>
                  <tr class="h-7">
                    <td class="border-2 border-gray-500">
                      {{ todo[table_setting.항목8.name] }}
                    </td>
                    <td class="border-2 border-gray-500">
                      {{ todo[table_setting.항목10.name] }}
                    </td>
                  </tr>
                  <tr class="h-7 font-bold bg-slate-200">
                    <td class="border-2 border-gray-500">진행상황</td>
                    <td class="border-2 border-gray-500">진행등록</td>
                  </tr>
                  <tr class="h-12">
                    <td
                      :class="[
      ...
      <div style="overflow-y: scroll; overflow-x: hidden; height: 550px">
        ...
        <div class="intro-y p-3">
          <table class="border-2 border-gray-500 w-full">
            <tbody class="text-center">
              <tr class="h-7 font-bold bg-slate-200">
                <td class="w-[35%] border-2 border-gray-500">작업코드</td>
                <td class="w-[65%] border-2 border-gray-500">공정</td>
              </tr>
              <tr class="h-7">
                <td class="border-2 border-gray-500">
              ...
              <tr class="h-7 font-bold bg-slate-200">
                <td class="border-2 border-gray-500">규격</td>
                <td class="border-2 border-gray-500">지시수량(단위)</td>
              </tr>
              <tr class="h-7">
                <td class="border-2 border-gray-500">
                  {{ productionResult.규격 }}
                ...
                <td class="border-2 border-gray-500">
                  {{ productionResult.지시수량 }}{{ productionResult.단위 }}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div class="intro-y p-3">
          <table class="border-2 border-gray-500 w-full">
            <tbody class="text-center">
              <tr class="h-7 font-bold bg-slate-200">
                <td class="border-2 border-gray-500">작업자</td>
                <td class="border-2 border-gray-500">설비명</td>
                <td class="border-2 border-gray-500">생산수</td>
              </tr>
              <tr class="h-7">
                <td class="border-2 border-gray-500">
                  <FormInput
              ...
              <tr class="h-7 font-bold bg-slate-200">
                <td colspan="2" class="border-2 border-gray-500">특이사항</td>
                <td class="border-2 border-gray-500">양품수</td>
              </tr>
              <tr class="h-7">
              ...
              <tr class="h-7 font-bold bg-slate-200">
                <td colspan="3" class="border-2 border-gray-500">시작일시</td>
              </tr>
              <tr class="h-7">
              ...
              <tr class="h-7 font-bold bg-slate-200">
                <td colspan="3" class="border-2 border-gray-500">종료일시</td>
              </tr>
              <tr class="h-7">
                <td colspan="3" class="border-2 border-gray-500">
                  <FormInput
            ...
            <Tab.Panel class="leading-relaxed">
              ...
              >
                <table class="border-2 border-gray-500 w-full">
                  <tbody class="text-center">
                    <tr class="h-7 font-bold bg-slate-200">
                      <td class="w-[65%] border-2 border-gray-500">LOT코드</td>
                      <td class="w-[35%] border-2 border-gray-500">품목구분</td>
                    </tr>
                    <tr class="h-7">
                      <td class="border-2 border-gray-500">
                        <FormInput
            ...
            <Tab.Panel>
              ...
              >
                <table class="border-2 border-gray-500 w-full">
                  <tbody class="text-center">
                    <tr class="h-7 font-bold bg-slate-200">
                      <td class="w-[65%] border-2 border-gray-500">불량코드</td>
                      <td class="w-[35%] border-2 border-gray-500">구분</td>
                    </tr>
                    <tr class="h-7">
                      <td class="border-2 border-gray-500">
                        <FormInput
            ...
            <Tab.Panel class="leading-relaxed">
              ...
              >
                <table class="border-2 border-gray-500 w-full">
                  <tbody class="text-center">
                    <tr class="h-7 font-bold bg-slate-200">
                      <td class="border-2 border-gray-500">비가동코드</td>
                    ...
                    <tr class="h-7 font-bold bg-slate-200">
                      ...
                      <td class="border-2 border-gray-500">내용</td>
                    </tr>
                    <tr class="h-7">
                      <td class="border-2 border-gray-500">
                        <FormInput
