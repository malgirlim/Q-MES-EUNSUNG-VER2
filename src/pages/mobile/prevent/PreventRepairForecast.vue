...
const user_level = proxy.gstate.level.PreventDailyNotify; //권한레벨
...
// dataManager 만들기
const url = "/api/info/prevent/repair/forecast";
...
<template>
  <div v-if="user_level >= 2">
    ...
    <div class="grid grid-cols-12 gap-1 mt-1">
      ...
      <div class="p-3 col-span-12 intro-y">
        <div v-if="dataManager.dataCount.value != 0" class="col-span-2">
        ...
        <div v-for="(todo, index) in dataManager.datas.value" :key="todo.NO">
            ...
            <div>
              <table class="border-2 border-gray-500 w-full">
                <tbody class="text-center">
                  <tr class="h-7">
                    <td
                      class="w-[20%] border-2 border-gray-500 font-bold bg-slate-200"
                    >
                      순번
                    </td>
                    <td class="w-[30%] border-2 border-gray-500">
