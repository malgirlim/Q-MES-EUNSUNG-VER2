            ...
            <div class="container">
              <div class="item" style="flex: 1 1 40%">
                ...
                <div class="grid grid-cols-12 gap-1 mt-1">
                  <div
                    class="flex flex-wrap items-center col-span-12 mt-2 sm:flex-nowrap"
                  >
                    <div class="hidden mx-auto md:block text-slate-500"></div>

                    <div class="px-3 pb-2 flex items-center text-center">
                      <div>
                        <Button
                      ...
                      <div class="ml-2">
                        <div class="items-center text-slate-500">
                          ...
                          >
                            <Lucide
                              icon="Search"
                              class="absolute top-28 right-5 w-4 h-4 my-auto mr-3"
                            />
                          </button>
                        </div>
                      </div>
                  ...
                  <!-- BEGIN: Pagination-->
                  <div
                    class="flex flex-wrap items-center col-span-12 mt-0 sm:flex-nowrap"
                  >
                    <div class="mx-auto">
                      <PaginationComponent
                    ...
                    <div class="flex items-center">
                      <div class="">
                        ...
                        <span class="mr-4">
                          [ {{ currentPage }} /
                          {{ dataManager.numberOfPages }} 페이지 ]</span
                        >
                      </div>
                      ...
                      <div class="ml-6">
                        ...
                        >
                          ...
                          <option>50</option>
                          <option>100</option>
                          <option :value="dataManager.dataCount.value">
                            전체
                          </option>
                        </FormSelect>
                      </div>
                    ...
                    >
                      <label class="cursor-pointer items-center">
                        <div class="mb-1 flex items-center">
                          <input
                            class="mb-1 mr-1 transition-all duration-100 ease-in-out shadow-sm border-slate-200 cursor-pointer focus:ring-4 focus:ring-offset-0 focus:ring-primary focus:ring-opacity-20 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 [&[type='radio']]:checked:bg-primary [&[type='radio']]:checked:border-primary [&[type='radio']]:checked:border-opacity-10"
                            id="radio"
                            type="radio"
                            :value="todo.NO"
                            v-model="radioSelect"
                        ...
                        <div
                          :class="[
                            '',
                            {
                              'outline outline-offset-2 outline-2 outline-warning':
                                radioSelect == todo.NO,
                            },
                          ]"
                        >
                          ...
                          >
                            <tbody class="text-center">
                              ...
                              <tr class="h-7 font-bold bg-slate-200">
                                ...
                                <td class="border-2 border-gray-500">수주일</td>
                                <td class="border-2 border-gray-500">납기일</td>
                              </tr>
                              ...
                              <tr class="h-7 font-bold bg-slate-200">
                                ...
                                <td class="border-2 border-gray-500">납품수</td>
                                <td class="border-2 border-gray-500">진행율</td>
                              </tr>
            ...
            <div class="grid grid-cols-2">
              <div class="col-span-2">
                ...
                <div class="item ml-3" style="flex: 1 1 40%">
                  ...
                  <div class="grid grid-cols-12 gap-1 mt-1">
                    <div
                      class="flex flex-wrap items-center col-span-12 mt-1 mb-1 mr-5 sm:flex-nowrap"
                    >
                      <div class="hidden mx-auto md:block text-slate-500"></div>
...
######################################################################################################################### -->
  ...
  >
    <Dialog.Panel>
      <div
        class="overflow-hidden box mb-3"
