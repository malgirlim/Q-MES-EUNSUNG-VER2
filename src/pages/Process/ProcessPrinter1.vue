...
const user_level = proxy.gstate.level.ProcessPrinter1; //권한레벨
...
const {
  ...
  insertAllData,
  numberOfPages,
} = useSendApi<StockItemReceive>(url, currentPage, rowsPerPage);
...
let insertModalData: StockItemReceive; // 등록할 변수
// 등록 함수
...
let editModalData: StockItemReceive; // 수정할 변수
