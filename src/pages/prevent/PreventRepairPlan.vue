...
const user_level = proxy.gstate.level.PreventRepairPlan; //권한레벨
...
const table_setting = {
  ...
  항목4: { name: "수리방법", style: "width: 50px; text-align: center;" },
        ...
        <Tab.Panels class="mt-5">
          <Tab.Panel class="leading-relaxed">
            ...
            >
              ...
              <div class="mt-3">
                <FormLabel htmlFor="vertical-form-5">수리방법</FormLabel>
                <FormInput
                  id="vertical-form-5"
                  type="text"
                  v-model="insertModalData.수리방법"
                  placeholder=""
                />
              </div>
              <div class="mt-3">
