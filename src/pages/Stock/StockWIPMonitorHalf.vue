...
const user_level = proxy.gstate.level.StockWIPMonitorHalf; //권한레벨
...
// dataManager 만들기
const url = "/api/stock/processstock/half";
const dataManager = useSendApi<StockProcess>(url, currentPage, rowsPerPage);
...
const table_setting = {
  ...
  항목6: { name: "품명", style: "width: 5px; text-align: center;" },
  항목7: { name: "규격", style: "width: 5px; text-align: center;" },
  항목8: { name: "단위", style: "width: 5px; text-align: center;" },
  항목9: { name: "불출수", style: "width: 5px; text-align: center;" },
  항목10: { name: "사용수", style: "width: 5px; text-align: center;" },
  항목11: { name: "재공수", style: "width: 5px; text-align: center;" },
...
// ########################## 등록, 수정, 삭제, 상세 Modal ##########################
// ##### 등록 Modal #####
let insertModalData: StockProcess;
