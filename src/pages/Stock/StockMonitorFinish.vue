...
const table_setting = {
  ...
  항목6: { name: "기초재고", style: "width: 5px; text-align: center;" },
  항목7: { name: "입고", style: "width: 5px; text-align: center;" },
  항목8: { name: "출하", style: "width: 5px; text-align: center;" },
  항목9: { name: "기말재고", style: "width: 5px; text-align: center;" },
  항목10: { name: "안전재고", style: "width: 5px; text-align: center;" },
  항목11: { name: "단가", style: "width: 5px; text-align: center;" },
  항목12: { name: "재고금액", style: "width: 5px; text-align: center;" },
...
// 품목 데이터 설정
const url_stock_stockLot = "/api/stock/stock/lot/fin";
const stock_stockLot = useSendApi<StockStockFinLOT>(
  url_stock_stockLot,
