...
import { StockItemProcess } from "../../interfaces/menu/stockInterface";
...
// dataManager 만들기
const url = "/api/stock/process/half";
const dataManager = useSendApi<StockItemProcess>(url, currentPage, rowsPerPage);

// 테이블항목 설정 및 가로크기 조정
const table_setting = {
  체크박스: { name: "체크박스", style: "width: 50px" },
  순번: { name: "순번", style: "width: 50px; text-align: center;" },
  항목1: { name: "공정", style: "width: 50px; text-align: center;" },
  항목2: { name: "구분", style: "width: 50px; text-align: center;" },
  항목3: { name: "불출일시", style: "width: 50px; text-align: center;" },
  항목4: { name: "입고코드", style: "width: 50px; text-align: center;" },
...
// ########################## 등록, 수정, 삭제, 상세 Modal ##########################
// ##### 등록 Modal #####
let insertModalData: StockItemProcess;
...
let editModalData: StockItemProcess; // 수정할 변수
// 수정버튼 누르면 실행되는 함수
