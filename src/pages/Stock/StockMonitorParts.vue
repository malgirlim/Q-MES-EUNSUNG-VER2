...
const user_level = proxy.gstate.level.StockMonitorParts; //권한레벨
...
// dataManager 만들기
const url = "/api/stock/fcltpart/stock";
const dataManager = useSendApi<StockStockFCLTPart>(
  url,
  currentPage,
  rowsPerPage
);
...
const table_setting = {
  ...
  항목3: { name: "부품구분", style: "width: 50px; text-align: center;" },
  항목4: { name: "품명", style: "width: 50px; text-align: center;" },
  항목5: { name: "규격", style: "width: 50px; text-align: center;" },
  항목6: { name: "단위", style: "width: 5px; text-align: center;" },
  항목7: { name: "기초재고", style: "width: 5px; text-align: center;" },
  항목8: { name: "입고", style: "width: 5px; text-align: center;" },
  항목9: { name: "출고", style: "width: 5px; text-align: center;" },
  항목10: { name: "기말재고", style: "width: 5px; text-align: center;" },
  항목11: { name: "안전재고", style: "width: 5px; text-align: center;" },
...
// 품목 데이터 설정
const url_stock_stockLot = "/api/stock/fcltpart/stock/lot";
const stock_stockLot = useSendApi<StockStockFCLTPartLOT>(
  url_stock_stockLot,
