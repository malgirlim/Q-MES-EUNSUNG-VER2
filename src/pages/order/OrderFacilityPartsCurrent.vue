...
import { OrderFacilityPart } from "../../interfaces/menu/orderInterface";
...
// dataManager 만들기
const url = "/api/order/facilitypart";
const dataManager = useSendApi<OrderFacilityPart>(
  url,
  currentPage,
  rowsPerPage
);
...
const table_setting = {
  ...
  항목6: { name: "발주수량", style: "width: 50px; text-align: center;" },
  항목7: { name: "납기일", style: "width: 50px; text-align: center;" },
  항목8: { name: "비고", style: "width: 50px; text-align: center;" },
...
// ########################## 등록, 수정, 삭제, 상세 Modal ##########################
// ##### 등록 Modal #####
let insertModalData: OrderFacilityPart;
const insertModal = ref(false);
const setInsertModal = (value: boolean) => {
  if (user_level >= 3) {
    router.push("/order/facility-parts");
...
let editModalData: OrderFacilityPart; // 수정할 변수
// 수정버튼 누르면 실행되는 함수
...
const onFileImportForm =
  "../../src/assets/xlsx/업로드양식_주문관리_설비부품발주현황.xlsx"; // 엑셀 양식주소
        ...
        <Tab.Panels class="mt-5">
          <Tab.Panel class="leading-relaxed">
            <div style="text-align: left">
              ...
              <div class="mt-3">
                <FormLabel htmlFor="vertical-form-4">발주일자</FormLabel>
                <FormInput
                  id="vertical-form-4"
                  type="text"
                  v-model="editModalData.발주일자"
                  placeholder=""
                  readonly
                />
              </div>
