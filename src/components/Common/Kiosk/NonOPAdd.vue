      ...
      <table class="w-full">
        ...
        <tbody>
          <tr class="text-center" v-for="i in Array(10).fill('10')">
            ...
            <td class="border-b-2 border-r-2 border-[#D9821C]">계획정지</td>
            <td class="border-b-2 border-r-2 border-[#D9821C]">휴식</td>
            <td class="border-b-2 border-r-2 border-[#D9821C]">휴게시간</td>
