...
const setEditCheck = (value: boolean) => {
  kiosk_item.searchDatas("", "작업NO", props.키오스크no, "", "");
    ...
    <Dialog.Panel>
      ...
      <div class="mt-5 px-5 pb-8 text-center">
        <Button
          ...
          @click="
            async () => {
              await kiosk_item.deleteData([deleteData]);
              await kiosk_item.searchDatas(
                '',
                '작업NO',
                props.키오스크no,
