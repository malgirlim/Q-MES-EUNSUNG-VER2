    ...
    <div class="header">
      <div>
        ...
        <div class="hide-in-print" style="margin-bottom: 10px">
          This page is rendered from a "template" Vue.js component.<br />You can
          modify the fields highlighted in green and interact with the buttons
          without having them in the print. Check out
          <a
            href="https://github.com/motla/vue-document-editor/blob/master/src/Demo/InvoiceTemplate.ce.vue"
            target="_blank"
            >InvoiceTemplate.ce.vue</a
          >
        </div>
      </div>
      <div>
      ...
      <tbody>
        <tr>
          ...
          <td style="min-width: 250px; text-align: right">
            <div>
              <b>Invoice number:</b>
              <span contenteditable="true" @keydown="preventLineBreaks">{{
        ...
        <tr>
          ...
          <td>
            ...
            <label class="hide-in-print" style="margin-left: 10px">
              <input type="checkbox" v-model="is_shipping_identical" />
              Identical
            </label>
          </td>
        </tr>
      ...
      <tbody>
        <tr>
          <td
            ...
            @input="(e) => (this.billing_address = e.target.innerHTML)"
          ></td>
          <td
            v-if="is_shipping_identical"
            v-html="billing_address"
        ...
        <tr>
          <td colspan="6" style="text-align: right">
            ...
            <span
              ...
              contenteditable="true"
              @input="
                (e) => (this.tax_percent = parseFloat(e.target.innerText))
              "
            ></span
            >%
          </td>
        ...
        <tr>
          <td colspan="6" style="text-align: right">
            ...
            <span
              ref="shipping"
              contenteditable="true"
              @input="(e) => (this.shipping = parseFloat(e.target.innerText))"
            ></span>
          </td>
        </tr>
        <tr>
