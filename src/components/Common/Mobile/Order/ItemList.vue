...
// emit(`update:modalclose`, false); // 버튼에 넣을 함수
</script>
<template>
  <div class="p-5">
    <div class="flex p-1">
      <div class="flex m-auto items-center">
        <Lucide class="w-5 h-5 mr-1" icon="List" /><strong>자재 목록</strong>
      </div>
    </div>
    <div
      class="text-md"
      style="height: 220px; overflow-y: visible; overflow-x: hidden"
    >
      <div>
        <div class="border-l-2 border-r-2 border-t-2 border-[#D9821C]">
          <table class="w-full">
            ...
            >
              <th class="border-r-2 border-[#D9821C] w-[25%]">LOT코드</th>
              <th class="border-r-2 border-[#D9821C] w-[25%]">품명</th>
              <th class="border-r-2 border-[#D9821C] w-[25%]">규격</th>
              <th class="border-r-2 border-[#D9821C] w-[15%]">단위</th>
              <th class="w-[10%]">선택</th>
            </thead>
            <tbody>
              <tr v-for="i in Array(10).fill('10')">
                ...
                <td class="py-1.5 text-center border-b-2 border-[#D9821C] h-7">
                  <Button variant="primary"
                    ><Lucide class="w-4 h-4" icon="CheckSquare"
                  /></Button>
                </td>
              </tr>
            </tbody>
    ...
    <div class="flex p-1">
      <div class="flex m-auto items-center">
        <Lucide class="w-5 h-5 mr-1" icon="List" /><strong>선택 목록</strong>
      </div>
    </div>
    <div
      class="text-md"
