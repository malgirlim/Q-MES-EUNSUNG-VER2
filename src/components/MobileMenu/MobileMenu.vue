...
<template>
  ...
  <div
    :class="[
      'w-full fixed bg-success/90 z-[60] border-b border-white/[0.08] -mt-5 -mx-3 sm:-mx-8 mb-6 dark:bg-darkmode-800/90 md:hidden',
  ...
  >
    ...
    <div
      ...
      :class="
        twMerge([
          'h-screen z-20 top-0 left-0 w-[270px] -ml-[100%] bg-success transition-all duration-300 ease-in-out dark:bg-darkmode-800',
